...
{
    public partial class FrmQA5Transaction : Form
    {

        public FrmQA5Transaction()
        {
            InitializeComponent();
        }
        ...
        private void FrmQA5Transaction_Load(object sender, EventArgs e)
        {
        ...
        private void btnNG_Click(object sender, EventArgs e)
        {
            ...
            GetProcessDest();
            dataacces_QA5.showgrid(DgvNGList, txtUnique.Text,"QA5");
            NG = true;
            OK = false;
            dispose = false;
        }
        ...
        private void btnshowNGtype_Click(object sender, EventArgs e)
        {
            FrmNG frm = new FrmNG();
            frm.Location = "QA5";
            frm.ShowDialog();
        ...
        private void btnAddToNG_Click(object sender, EventArgs e)
        {
            ...
            if (dataacces_QA5.InsertoListNG(listNg))
            {
                dataacces_QA5.showgrid(DgvNGList, txtUnique.Text, listNg.Process);
        ...
        private void btnDeleteNG_Click(object sender, EventArgs e)
        {
            if (DgvNGList.SelectedCells.Count > 0)
            {
                ...
                if (dialogResult == DialogResult.Yes)
                {
                    ...
                    if (dataacces_QA5.DeleteNGList(txtUnique.Text,IDNGList,"QA5" ) == true)
                    {
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            if (AppSettings.Authority == "Leader" || AppSettings.Authority == "Administrator")
            {
                ...
                //    if (!dataacces_QA5.CheckModel(txtModelName.Text))
                //    {
                //        MessageBox.Show("Model not found!");
                //        return;
                //    }
                //    if (!dataacces_QA5.CheckColor(txtColor.Text))
                //    {
                //        MessageBox.Show("Color not found!");
                //        return;
                //    }
                //    if (dataacces_QA5.UpdateModel(txtUnique.Text, model,txtModelName.Text,txtColor.Text))
                //    {
                //        model = model + 1;
                //        if (model == 1)
                //        {
                        ...
                        else
                        {
                            ...
                            if (txtEPC.Text == epc)
                            {
                                ...
                                if (dialogResult == DialogResult.Yes)
                                {
                                    ...
                                    history.History_ProcessLine = "QA5";
                                    if (OK == true)
                                        history.History_ReceiveLine = "QA6";
                                    else
                                        history.History_ReceiveLine = "QA5";
                                    history.model = model;
                                    history.History_SerianRFID = txtserialRFID.Text;
                                    if (dataacces_QA5.InserttoHistory(history))
                                    {
